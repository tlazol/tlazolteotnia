export const bodyClassName = [
  'm-0 min-w-80 font-sans text-[var(--text)] selection:bg-[var(--post-accent)] selection:text-[var(--bg)] [color-scheme:dark] [&_:focus-visible]:[outline:2px_solid_var(--post-accent)] [&_:focus-visible]:[outline-offset:4px]',
